...
<assessmentItem xmlns="http://www.imsglobal.org/xsd/imsqti_v2p1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqti_v2p1  http://www.imsglobal.org/xsd/qti/qtiv2p1/imsqti_v2p1.xsd" 
   identifier="P1M123" title="Recycling Claw Item 14" adaptive="false" timeDependent="false">
   <itemBody>
      <div id="task" class="g-task p1-m1 p1-m1-23 p1-check-finish p1-confirm-finish p1-check-efficiency p1-help-stats" data-itemid="P1M123" data-blocks="11" data-module="RobotArm" data-progress="lc">
         <div class="task-title g-hide" data-am-translate="m123.task.title" data-am-translate-group="m1.title">Recycling Claw - Learning task 2 of 3</div>
         <div class="g-instructions-help-wrapper">
            <div class="g-instructions g-avatar">
               ...
               <div> 
                  <p class="g-text-top">
                     <span data-am-translate="m123.instruction.1" data-am-translate-group="m123.instruction" data-wysiwyg="false">Make the recycling claw match the goal state.</span>
                  </p>
                  <p class="g-text-bottom" data-am-translate="m123.instruction.4" data-am-translate-group="m123.instruction" data-wysiwyg="false">
         ...
         <div class="p1-m1-world-section">
            <div class="g-blockly-container">
               ...
               <div id="blocklyDiv" data-id="P1M123" class="g-blockly"></div>
         ...
         <div class="g-hide g-task-hint">
            <div class="g-hint-page3 g-switch-content g-invisible">
               ...
               <ul><li data-am-translate="m1.popup.hint.3.2" data-wysiwyg="false" data-am-translate-group="m1.hint">Move an object to the goal state position, place it, and return the claw to its starting position.</li>
                     <li data-am-translate="m1.popup.hint.3.3" data-wysiwyg="false" data-am-translate-group="m1.hint">Repeat the actions above three times</li></ul>
         ...
         <div class="g-hide g-task-solution">
            <div class="g-solution-page g-switch-content g-invisible" data-init="P1M123_P1H3">
               <div class="p1-m1-world-section">
                  <div class="g-blockly-container g-solution-correct">            
                     ...
                     <div class="g-blockly" id="blocklyDivH123"></div>
                  <div class="p1-world-btn-strip">
                        <button class="g-btn-blockly g-btn-press g-btn-ico g-btn-blockly-run-h123" reset-target=".g-blockly-target-h123">
                           <i class="g-rtl-img fas fa-play"></i>
                           <span class="blockly-run-btn" data-am-translate="m1.buttons.run" data-am-translate-group="m1.buttons" data-wysiwyg="false">Run</span>
                           <span class="blockly-reset-btn g-hide" data-am-translate="m1.buttons.reset" data-am-translate-group="m1.buttons" data-wysiwyg="false">Reset</span>
                        </button>
                  ...
                  <div class="g-blockly-container">            
                     ...
                     <div class="p1-world-btn-strip">
                        <button class="g-btn-blockly g-btn-press g-btn-ico g-btn-blockly-run-hsa" reset-target=".g-blockly-target-h123">
                           <i class="g-rtl-img fas fa-play"></i>
                           <span class="blockly-run-btn" data-am-translate="m1.buttons.run" data-am-translate-group="m1.buttons" data-wysiwyg="false">Run</span>
                           <span class="blockly-reset-btn g-hide" data-am-translate="m1.buttons.reset" data-am-translate-group="m1.buttons" data-wysiwyg="false">Reset</span>
                        </button>
                  ...
                  <div class="p1-m1-world-panel">
                     <div class="p1-m1-world-container">
                        ...
                        <div class="p1-m1-world-header"></div>
                        <div id="robo-world1-h123" class="p1-m1-world g-blockly-target-h123 g-blockly-target-hsa"></div>
                     </div>
                     <div class="p1-m1-world-container">
                        <div class="p1-m1-world-tabs g-clearfix">
                           <div class="g-rtl-float-left p1-m1-goal-title g-blockly-tab" data-am-translate="m1.world.2" data-am-translate-group="m1.world" data-wysiwyg="false">Goal state</div>
                        ...
                        <div class="p1-m1-world-header"></div>
                        <div id="robo-world2-h123" class="p1-m1-world p1-m1-goal"></div>
                     </div>      
                     <div class="p1-world-btn-strip">
                        <div class="g-blockly-speed-holder"></div>
                     </div>
